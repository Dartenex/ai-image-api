...
class SDK {
  ...
  constructor() {
    ...
    this.core = new APICore(this.spec, 'picsartfordevelopers/2.0 (api/6.1.0)');
  }
   ...
   * **Service Description:**
   *
   * The *removebg* service removes the background of an image. Utilizing high-end AI
   * technology, our background remover detects the foreground object and automatically
   * separates it from the background. Our algorithm is capable of handling the most diverse
   * use cases, like small jewelry details, human hair, furry segments or any other complex
   * edge types. Whether it's a product for sale, graphical materials for your best campaign
   * or just personal images for fun editing, you will get clear edges with awesome detail
   * preservation.
   *
   * **Limitations:**
   *
   ...
   */
  postRemovebg(
    body?: types.PostRemovebgBodyParam
  ): Promise<FetchResponse<200, types.PostRemovebgResponse200>> {
   ...
   */
  postUpscale(
    body: types.PostUpscaleBodyParam
  ): Promise<FetchResponse<200, types.PostUpscaleResponse200>> {
   ...
   */
  postUpscaleUltra(
    body?: types.PostUpscaleUltraBodyParam
  ): Promise<
    | FetchResponse<200, types.PostUpscaleUltraResponse200>
    | FetchResponse<202, types.PostUpscaleUltraResponse202>
  > {
   ...
   */
  getUpscaleUltraTransaction_id(
    metadata: types.GetUpscaleUltraTransactionIdMetadataParam
  ): Promise<
    | FetchResponse<200, types.GetUpscaleUltraTransactionIdResponse200>
    | FetchResponse<202, types.GetUpscaleUltraTransactionIdResponse202>
  > {
   ...
   */
  postUpscaleEnhance(
    body?: types.PostUpscaleEnhanceBodyParam
  ): Promise<
    | FetchResponse<200, types.PostUpscaleEnhanceResponse200>
    | FetchResponse<202, types.PostUpscaleEnhanceResponse202>
  > {
   ...
   */
  postEffects(
    body: types.PostEffectsBodyParam
  ): Promise<FetchResponse<200, types.PostEffectsResponse200>> {
   ...
   */
  postEffectsPreviews(
    body: types.PostEffectsPreviewsBodyParam
  ): Promise<FetchResponse<200, types.PostEffectsPreviewsResponse200>> {
   ...
   */
  postAdjust(
    body?: types.PostAdjustBodyParam
  ): Promise<FetchResponse<200, types.PostAdjustResponse200>> {
   ...
   */
  postStyletransfer(
    body?: types.PostStyletransferBodyParam
  ): Promise<FetchResponse<200, types.PostStyletransferResponse200>> {
   ...
   */
  postMasks(
    body: types.PostMasksBodyParam
  ): Promise<FetchResponse<200, types.PostMasksResponse200>> {
   ...
   */
  postMasksPreviews(
    body: types.PostMasksPreviewsBodyParam
  ): Promise<FetchResponse<200, types.PostMasksPreviewsResponse200>> {
  ...
  postBackgroundTexture(
    body?: types.PostBackgroundTextureBodyParam
  ): Promise<FetchResponse<200, types.PostBackgroundTextureResponse200>> {
   ...
   */
  postVectorizer(
    body?: types.PostVectorizerBodyParam
  ): Promise<FetchResponse<200, types.PostVectorizerResponse200>> {
   ...
   */
  postUpload(
    body?: types.PostUploadBodyParam
  ): Promise<FetchResponse<200, types.PostUploadResponse200>> {
   ...
   */
  postEnhanceFace(
    body?: types.PostEnhanceFaceBodyParam
  ): Promise<FetchResponse<200, types.PostEnhanceFaceResponse200>> {
...
export type {
  ...
  GetBalanceResponse400,
  GetBalanceResponse401,
  GetBalanceResponse403,
  GetBalanceResponse404,
  GetBalanceResponse405,
  GetBalanceResponse413,
  GetBalanceResponse415,
  GetBalanceResponse429,
  GetBalanceResponse431,
  GetBalanceResponse500,
  GetBalanceResponse503,
  GetEffectsResponse200,
  GetEffectsResponse400,
  GetEffectsResponse401,
  GetEffectsResponse403,
  GetEffectsResponse404,
  GetEffectsResponse405,
  GetEffectsResponse413,
  GetEffectsResponse415,
  GetEffectsResponse429,
  GetEffectsResponse431,
  GetEffectsResponse500,
  GetEffectsResponse503,
  GetUpscaleUltraTransactionIdMetadataParam,
  GetUpscaleUltraTransactionIdResponse200,
  GetUpscaleUltraTransactionIdResponse202,
  GetUpscaleUltraTransactionIdResponse400,
  GetUpscaleUltraTransactionIdResponse401,
  GetUpscaleUltraTransactionIdResponse403,
  GetUpscaleUltraTransactionIdResponse404,
  GetUpscaleUltraTransactionIdResponse405,
  GetUpscaleUltraTransactionIdResponse413,
  GetUpscaleUltraTransactionIdResponse415,
  GetUpscaleUltraTransactionIdResponse429,
  GetUpscaleUltraTransactionIdResponse431,
  GetUpscaleUltraTransactionIdResponse500,
  GetUpscaleUltraTransactionIdResponse503,
  PostAdjustBodyParam,
  PostAdjustResponse200,
  PostAdjustResponse400,
  PostAdjustResponse401,
  PostAdjustResponse403,
  PostAdjustResponse404,
  PostAdjustResponse405,
  PostAdjustResponse413,
  PostAdjustResponse415,
  PostAdjustResponse429,
  PostAdjustResponse431,
  PostAdjustResponse500,
  PostAdjustResponse503,
  PostBackgroundTextureBodyParam,
  PostBackgroundTextureResponse200,
  PostBackgroundTextureResponse400,
  PostBackgroundTextureResponse401,
  PostBackgroundTextureResponse403,
  PostBackgroundTextureResponse404,
  PostBackgroundTextureResponse405,
  PostBackgroundTextureResponse413,
  PostBackgroundTextureResponse415,
  PostBackgroundTextureResponse429,
  PostBackgroundTextureResponse431,
  PostBackgroundTextureResponse500,
  PostBackgroundTextureResponse503,
  PostEditBodyParam,
  PostEditResponse200,
  PostEditResponse400,
  PostEditResponse401,
  ...
  PostEditResponse500,
  PostEditResponse503,
  PostEffectsBodyParam,
  PostEffectsPreviewsBodyParam,
  PostEffectsPreviewsResponse200,
  PostEffectsPreviewsResponse400,
  PostEffectsPreviewsResponse401,
  PostEffectsPreviewsResponse403,
  PostEffectsPreviewsResponse404,
  PostEffectsPreviewsResponse405,
  PostEffectsPreviewsResponse413,
  PostEffectsPreviewsResponse415,
  PostEffectsPreviewsResponse429,
  PostEffectsPreviewsResponse431,
  PostEffectsPreviewsResponse500,
  PostEffectsPreviewsResponse503,
  PostEffectsResponse200,
  PostEffectsResponse400,
  PostEffectsResponse401,
  PostEffectsResponse403,
  PostEffectsResponse404,
  PostEffectsResponse405,
  PostEffectsResponse413,
  PostEffectsResponse415,
  PostEffectsResponse429,
  PostEffectsResponse431,
  PostEffectsResponse500,
  PostEffectsResponse503,
  PostEnhanceFaceBodyParam,
  PostEnhanceFaceResponse200,
  PostEnhanceFaceResponse400,
  PostEnhanceFaceResponse401,
  PostEnhanceFaceResponse403,
  PostEnhanceFaceResponse404,
  PostEnhanceFaceResponse405,
  PostEnhanceFaceResponse413,
  PostEnhanceFaceResponse415,
  PostEnhanceFaceResponse429,
  PostEnhanceFaceResponse431,
  PostEnhanceFaceResponse500,
  PostEnhanceFaceResponse503,
  PostMasksBodyParam,
  PostMasksPreviewsBodyParam,
  PostMasksPreviewsResponse200,
  PostMasksPreviewsResponse400,
  PostMasksPreviewsResponse401,
  PostMasksPreviewsResponse403,
  PostMasksPreviewsResponse404,
  PostMasksPreviewsResponse405,
  PostMasksPreviewsResponse413,
  PostMasksPreviewsResponse415,
  PostMasksPreviewsResponse429,
  PostMasksPreviewsResponse431,
  PostMasksPreviewsResponse500,
  PostMasksPreviewsResponse503,
  PostMasksResponse200,
  PostMasksResponse400,
  PostMasksResponse401,
  PostMasksResponse403,
  PostMasksResponse404,
  PostMasksResponse405,
  PostMasksResponse413,
  PostMasksResponse415,
  PostMasksResponse429,
  PostMasksResponse431,
  PostMasksResponse500,
  PostMasksResponse503,
  PostRemovebgBodyParam,
  PostRemovebgResponse200,
  PostRemovebgResponse400,
  PostRemovebgResponse401,
  PostRemovebgResponse403,
  PostRemovebgResponse404,
  PostRemovebgResponse405,
  PostRemovebgResponse413,
  PostRemovebgResponse415,
  PostRemovebgResponse429,
  PostRemovebgResponse431,
  PostRemovebgResponse500,
  PostRemovebgResponse503,
  PostStyletransferBodyParam,
  PostStyletransferResponse200,
  PostStyletransferResponse400,
  PostStyletransferResponse401,
  PostStyletransferResponse403,
  PostStyletransferResponse404,
  PostStyletransferResponse405,
  PostStyletransferResponse413,
  PostStyletransferResponse415,
  PostStyletransferResponse429,
  PostStyletransferResponse431,
  PostStyletransferResponse500,
  PostStyletransferResponse503,
  PostUploadBodyParam,
  PostUploadResponse200,
  PostUploadResponse400,
  PostUploadResponse401,
  PostUploadResponse403,
  PostUploadResponse404,
  PostUploadResponse405,
  PostUploadResponse413,
  PostUploadResponse415,
  PostUploadResponse429,
  PostUploadResponse431,
  PostUploadResponse500,
  PostUploadResponse503,
  PostUpscaleBodyParam,
  PostUpscaleEnhanceBodyParam,
  PostUpscaleEnhanceResponse200,
  PostUpscaleEnhanceResponse202,
  PostUpscaleEnhanceResponse400,
  PostUpscaleEnhanceResponse401,
  PostUpscaleEnhanceResponse403,
  PostUpscaleEnhanceResponse404,
  PostUpscaleEnhanceResponse405,
  PostUpscaleEnhanceResponse413,
  PostUpscaleEnhanceResponse415,
  PostUpscaleEnhanceResponse429,
  PostUpscaleEnhanceResponse431,
  PostUpscaleEnhanceResponse500,
  PostUpscaleEnhanceResponse503,
  PostUpscaleResponse200,
  PostUpscaleResponse400,
  PostUpscaleResponse401,
  PostUpscaleResponse403,
  PostUpscaleResponse404,
  PostUpscaleResponse405,
  PostUpscaleResponse413,
  PostUpscaleResponse415,
  PostUpscaleResponse429,
  PostUpscaleResponse431,
  PostUpscaleResponse500,
  PostUpscaleResponse503,
  PostUpscaleUltraBodyParam,
  PostUpscaleUltraResponse200,
  PostUpscaleUltraResponse202,
  PostUpscaleUltraResponse400,
  PostUpscaleUltraResponse401,
  PostUpscaleUltraResponse403,
  PostUpscaleUltraResponse404,
  PostUpscaleUltraResponse405,
  PostUpscaleUltraResponse413,
  PostUpscaleUltraResponse415,
  PostUpscaleUltraResponse429,
  PostUpscaleUltraResponse431,
  PostUpscaleUltraResponse500,
  PostUpscaleUltraResponse503,
  PostVectorizerBodyParam,
  PostVectorizerResponse200,
  PostVectorizerResponse400,
  PostVectorizerResponse401,
  PostVectorizerResponse403,
  PostVectorizerResponse404,
  PostVectorizerResponse405,
  PostVectorizerResponse413,
  PostVectorizerResponse415,
  PostVectorizerResponse429,
  PostVectorizerResponse431,
  PostVectorizerResponse500,
  PostVectorizerResponse503,
} from './types';
