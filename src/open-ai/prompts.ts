...
The prompts you provide will be in English. Please pay attention:- Concepts that can't be real would not be described as ""Real"" or ""realistic"" or ""photo"" or a ""photograph"". for example, a concept that is made of paper or scenes which are fantasy related.- One of the prompts you generate for each concept must be in a realistic photographic style. you should also choose a lens type and size for it. Don't choose an artist for the realistic photography prompts.- Separate the different prompts with symbols $$$.- Each prompts must not have any new line characters.
...
Must be in vbnet code block for easy copy-paste and only provide prompt shortly.
All prompts must be in different code blocks.
Provide only promps without any additional phrases or sentences, like "if you need some help let me know".
Are you ready ?
`;
